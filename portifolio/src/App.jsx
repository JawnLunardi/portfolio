...
experiência por meio de estudos com HTML, CSS, JavaScript, React, Node.js e Kotlin.</p>
                <div className="btn-contato">
                  <a href="https://wa.me/5524998172656" target='blank'><button>entre em contato</button></a>
                </div>
              </div>
        ...
        <section className='especialidades'>
          ...
          <div className="flex">
            ...
            <img className='mobileapp' src="public/gas_or_eth.png" alt="" />
          ...
          <li>Jetpack Compose</li>
            ...
            <img className='webapp' src="public/weather.png" alt="" />
          ...
          <li>Node.js</li>
            ...
            <img className='webapp' src="public/soccerfans.png" alt="" />
