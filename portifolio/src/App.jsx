...
Fluminense (UFF) com mais de um ano de estudos e atuação como freelancer. </p> <p>Minhas especialidades incluem HTML5, CSS3, JavaScript, React.js, Node.js, Ruby on Rails e Kotlin, além de MySQL e Git, entregando soluções modernas e funcionais.</p>
                <div className="btn-contato">
